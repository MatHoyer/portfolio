...
export const JavaScript: React.FC<Props> = ({ width = 100, height = 100 }) => {
    return (
...
export const Cplusplus: React.FC<Props> = ({ width = 100, height = 100 }) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width={width} height={height} viewBox="0 0 48 48">
            <path
                fill="#00549d"
...
export const C: React.FC<Props> = ({ width = 100, height = 100 }) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width={width} height={height} viewBox="0 0 48 48">
            <path
                fill="#00549d"
...
export const TypeScript: React.FC<Props> = ({ width = 100, height = 100 }) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width={width} height={height} viewBox="0 0 48 48">
            <linearGradient
...
export const Python: React.FC<Props> = ({ width = 100, height = 100 }) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width={width} height={height} viewBox="0 0 48 48">
            <path
                fill="#0277BD"
...
export const Docker: React.FC<Props> = ({ width = 100, height = 100 }) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width={width} height={height} viewBox="0 0 48 48">
            <path
                fill="#2395ec"
